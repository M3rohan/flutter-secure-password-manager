...
void _passwordEntrySerialize(
  ...
  writer.writeString(offsets[2], object.encryptedPassword);
...
PasswordEntry _passwordEntryDeserialize(
  ...
  object.encryptedPassword = reader.readString(offsets[2]);
  object.id = id;
...
extension PasswordEntryQuerySortBy
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByCategory() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> sortByUsername() {
    return QueryBuilder.apply(this, (query) {
...
extension PasswordEntryQuerySortThenBy
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }

  QueryBuilder<PasswordEntry, PasswordEntry, QAfterSortBy> thenByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }
...
extension PasswordEntryQueryWhereDistinct
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PasswordEntry, PasswordEntry, QDistinct> distinctByUsername(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PasswordEntryQueryProperty
  ...
  QueryBuilder<PasswordEntry, String?, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PasswordEntry, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<PasswordEntry, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'title');
    });
  }

  QueryBuilder<PasswordEntry, String, QQueryOperations> usernameProperty() {
    return QueryBuilder.apply(this, (query) {
